...
App categories Reviews and ratings Free vs. paid apps App installations App price App sizes Various visualizations and charts, such as bar graphs, pie charts, line charts, and scatter plots, were generated to effectively communicate key findings and trends derived from the data analysis.
### Dashboard
...
(https://www.kaggle.com/datasets/yash16jr/google-play-store-cleaned). Open the dataset in Excel. Follow the README instructions to preprocess the data and conduct the analysis. Explore the dashboard to interactively visualize key insights from the data.
